...
$updatequery = doquery("UPDATE {{table}} SET imagem='descansando.png' WHERE charname='$usuariologadonome' LIMIT 1","users");
    ...
    $indexconteudo = "Você recuperou 1 de HP e 2 de Chakra...<meta HTTP-EQUIV='refresh' CONTENT='1;URL=encherhp.php'>";
...
$updatequery = doquery("UPDATE {{table}} SET recuperarvida='0' WHERE charname='$usuariologadonome' LIMIT 1","users");
	    ...
	    $indexconteudo = "Você recuperou 2 de HP e 3 de Chakra...<meta HTTP-EQUIV='refresh' CONTENT='1;URL=encherhp.php'>";
	$valorlib = 1; //para nao repetir o lib.php
	$indexconteudo = "<center><table  bgcolor=\"#452202\"><tr><td width=\"18\"></td><td width=\"*\"><center><font color=white>Descansando</font></center></td><td width=\"18\"><a href=\"index.php\"><img src=\"images/deletar2.jpg\" title=\"Parar de Descansar\"  alt=\"X\" border=\"0\"></a></td></tr><tr><td background=\"layoutnovo/menumeio/meio2.png\" colspan=\"3\"><font color=\"black\"><center>".$indexconteudo."</center></font></td></tr></table></center>";
	include('index.php');
	die();
