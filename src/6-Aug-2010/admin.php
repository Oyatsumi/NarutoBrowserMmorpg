...
if ($userrow == false) { die("Por favor faça o <a href=\"login.php?do=login\">log in</a> antes de usar o Painel de Controle."); }
...
towns="$towns", bancoid1="$bancoid1", bancoid2="$bancoid2", bancoid3="$bancoid3", bancoid4="$bancoid4", bancoid5="$bancoid5", bancoid6="$bancoid6", banconome1="$banconome1", banconome2="$banconome2", banconome3="$banconome3", banconome4="$banconome4", banconome5="$banconome5", banconome6="$banconome6", b2_bancoid1="$b2_bancoid1", b2_bancoid2="$b2_bancoid2", b2_bancoid3="$b2_bancoid3", b2_bancoid4="$b2_bancoid4", b2_bancoid5="$b2_bancoid5", b2_bancoid6="$b2_bancoid6", b2_banconome1="$b2_banconome1", b2_banconome2="$b2_banconome2", b2_banconome3="$b2_banconome3", b2_banconome4="$b2_banconome4", b2_banconome5="$b2_banconome5", b2_banconome6="$b2_banconome6", avatar="$avatar", agilidade="$agilidade", sorte="$sorte", inteligencia="$inteligencia", determinacao="$determinacao", precisao="$precisao", graduacao="$graduacao", pontoatributos="$pontoatributos", missao="$missao", senjutsutimer="$senjutsutimer" WHERE id="$id" LIMIT 1
END;
...
<tr><td width="20%">Arma ID do Banco de Trocas:</td><td><input type="text" name="bancoid1" size="50" maxlength="50" value="{{bancoid1}}" /></td></tr>
<tr><td width="20%">Colete ID do Banco de Trocas:</td><td><input type="text" name="bancoid2" size="50" maxlength="50" value="{{bancoid2}}" /></td></tr>
<tr><td width="20%">Bandana ID do Banco de Trocas:</td><td><input type="text" name="bancoid3" size="50" maxlength="50" value="{{bancoid3}}" /></td></tr>
<tr><td width="20%">Slot 1 ID do Banco de Trocas:</td><td><input type="text" name="bancoid4" size="50" maxlength="50" value="{{bancoid4}}" /></td></tr>
<tr><td width="20%">Slot 2 ID do Banco de Trocas:</td><td><input type="text" name="bancoid5" size="50" maxlength="50" value="{{bancoid5}}" /></td></tr>
<tr><td width="20%">Slot 3 ID do Banco de Trocas:</td><td><input type="text" name="bancoid6" size="50" maxlength="50" value="{{bancoid6}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Arma Nome do Banco de Trocas:</td><td><input type="text" name="banconome1" size="50" maxlength="50" value="{{banconome1}}" /></td></tr>
<tr><td width="20%">Colete Nome do Banco de Trocas:</td><td><input type="text" name="banconome2" size="50" maxlength="50" value="{{banconome2}}" /></td></tr>
<tr><td width="20%">Bandana Nome do Banco de Trocas:</td><td><input type="text" name="banconome3" size="50" maxlength="50" value="{{banconome3}}" /></td></tr>
<tr><td width="20%">Slot 1 Nome do Banco de Trocas:</td><td><input type="text" name="banconome4" size="50" maxlength="50" value="{{banconome4}}" /></td></tr>
<tr><td width="20%">Slot 2 Nome do Banco de Trocas:</td><td><input type="text" name="banconome5" size="50" maxlength="50" value="{{banconome5}}" /></td></tr>
<tr><td width="20%">Slot 3 Nome do Banco de Trocas:</td><td><input type="text" name="banconome6" size="50" maxlength="50" value="{{banconome6}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>


<tr><td width="20%">Arma ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid1" size="50" maxlength="50" value="{{b2_bancoid1}}" /></td></tr>
<tr><td width="20%">Colete ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid2" size="50" maxlength="50" value="{{b2_bancoid2}}" /></td></tr>
<tr><td width="20%">Bandana ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid3" size="50" maxlength="50" value="{{b2_bancoid3}}" /></td></tr>
<tr><td width="20%">Slot 1 ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid4" size="50" maxlength="50" value="{{b2_bancoid4}}" /></td></tr>
<tr><td width="20%">Slot 2 ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid5" size="50" maxlength="50" value="{{b2_bancoid5}}" /></td></tr>
<tr><td width="20%">Slot 3 ID do Banco de Armazenamento:</td><td><input type="text" name="b2_bancoid6" size="50" maxlength="50" value="{{b2_bancoid6}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Arma Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome1" size="50" maxlength="50" value="{{b2_banconome1}}" /></td></tr>
<tr><td width="20%">Colete Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome2" size="50" maxlength="50" value="{{b2_banconome2}}" /></td></tr>
<tr><td width="20%">Bandana Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome3" size="50" maxlength="50" value="{{b2_banconome3}}" /></td></tr>
<tr><td width="20%">Slot 1 Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome4" size="50" maxlength="50" value="{{b2_banconome4}}" /></td></tr>
<tr><td width="20%">Slot 2 Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome5" size="50" maxlength="50" value="{{b2_banconome5}}" /></td></tr>
<tr><td width="20%">Slot 3 Nome do Banco de Armazenamento:</td><td><input type="text" name="b2_banconome6" size="50" maxlength="50" value="{{b2_banconome6}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>
<tr><td width="20%">Avatar (Número):</td><td><input type="text" name="avatar" size="50" maxlength="50" value="{{avatar}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Agilidade:</td><td><input type="text" name="agilidade" size="50" maxlength="50" value="{{agilidade}}" /></td></tr>
<tr><td width="20%">Sorte:</td><td><input type="text" name="sorte" size="50" maxlength="50" value="{{sorte}}" /></td></tr>
<tr><td width="20%">Inteligência:</td><td><input type="text" name="inteligencia" size="50" maxlength="50" value="{{inteligencia}}" /></td></tr>
<tr><td width="20%">Precisão:</td><td><input type="text" name="precisao" size="50" maxlength="50" value="{{precisao}}" /></td></tr>
<tr><td width="20%">Determinação:</td><td><input type="text" name="determinacao" size="50" maxlength="50" value="{{determinacao}}" /></td></tr>
<tr><td width="20%">Ponto de Atributos para Distribuir:</td><td><input type="text" name="pontoatributos" size="50" maxlength="50" value="{{pontoatributos}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Missão que o Jogador Está (Número):</td><td><input type="text" name="missao" size="50" maxlength="50" value="{{missao}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Graduação:</td><td><input type="text" name="graduacao" size="50" maxlength="50" value="{{graduacao}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Tempo para Terminar Senjutsu (segundos):</td><td><input type="text" name="senjutsutimer" size="50" maxlength="50" value="{{senjutsutimer}}" /></td></tr>
