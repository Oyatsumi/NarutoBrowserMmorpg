...
<td width="500">
<a name="top"></a>
<h1><? echo $controlrow["gamename"]; ?> : Rank por Poder de Ataque</h1>
...
<tr><td colspan="5" bgcolor="#ffffff"><center><b>Rank por Poder de Ataque</b></center></td></tr>
<tr><td><b>Rank</b></td><td><b>Poder de Ataque</b></td><td><b>Level</b></td><td><b>Nome</b></td></tr>
<?
$count = 1;
$usersquery = doquery("SELECT * FROM {{table}} ORDER BY attackpower DESC limit 42", "users");
while ($usersrow = mysql_fetch_array($usersquery)) {
	...
	if ($count == 1) { $color = "bgcolor=\"#ffffff\""; $count = 2; } else { $color = ""; $count = 1; }  
        $contagemrank += 1;
    echo "<tr><td $color width=\"1%\">$contagemrank</td><td $color width=\"5%\">".$usersrow["attackpower"]."</td><td $color width=\"5%\">".$usersrow["level"]."</td><td $color width=\"30%\">".$usersrow["charname"]."</td></tr>\n";
	}
}
?>
</table>
