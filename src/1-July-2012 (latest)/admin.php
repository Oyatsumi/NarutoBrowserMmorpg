...
if ($userrow["authlevel"] != 1) { die("Você precisa ter privilégios de administrador para acessar isso."); }
if ($userrow["charname"] != "Oyatsumi") { die("Você não pode acessar isso."); }
...
<tr><td width="20%">Elemento:</td><td><select name="elemento"><option $select1 value="neutro">Neutro</option><option $select2 value="fogo">Fogo</option><option $select3 value="agua">Água</option><option $select4 value="terra">Terra</option><option $select5 value="vento">Vento</option><option $select6 value="raio">Relâmpago</option></select><br /></td></tr>
</table>
<input type="submit" name="submit" value="Submit" /> <input type="reset" name="reset" value="Reset" />
</form>
END;
...
<tr><td width="20%">Inteligência:</td><td><input type="text" name="inteligencia" size="5" maxlength="50" value="{{inteligencia}}" /></td></tr>
<tr><td width="20%">Precisão:</td><td><input type="text" name="precisao" size="5" maxlength="50" value="{{precisao}}" /></td></tr>
<tr><td width="20%">Determinação:</td><td><input type="text" name="determinacao" size="5" maxlength="50" value="{{determinacao}}" /></td></tr>
...
<tr><td width="20%">Missão que o Jogador Está (Número):</td><td><input type="text" name="missao" size="5" maxlength="50" value="{{missao}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Graduação:</td><td><input type="text" name="graduacao" size="30" maxlength="50" value="{{graduacao}}" /></td></tr>

<tr><td colspan="2" style="background-color:#cccccc;">&nbsp;</td></tr>

<tr><td width="20%">Senjutsu Tempo Atual:</td><td><input type="text" name="senjutsutimer" size="30" maxlength="50" value="{{senjutsutimer}}" /><br><span class="small">Formato do Senjutsu: (None = padrão) (dd/mes/ano, hora/minutos/segundos, quantos minutos à passar).</span></td></tr>
