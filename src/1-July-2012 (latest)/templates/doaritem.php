...
<option value="1">Arma que está no meu Banco de Trocas</option>
<option value="2">Colete que está no meu Banco de Trocas</option>
<option value="3">Bandana que está no meu Banco de Trocas</option>
<option value="4">Slot 1 que está no meu Banco de Trocas</option>
<option value="5">Slot 2 que está no meu Banco de Trocas</option>
<option value="6">Slot 3 que está no meu Banco de Trocas</option>
