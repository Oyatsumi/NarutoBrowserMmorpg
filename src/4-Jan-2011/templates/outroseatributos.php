...
<tr bgcolor="#E4D094"><td colspan="2"><div class="buttons" style="margin-left: 3px;"><center><button type="submit" class="positive" name="submit"><img src="layoutnovo/dropmenu/b1.gif"> Adicionar Pontos</button>
<button type="reset" class="negative" name="reset"><img src="layoutnovo/dropmenu/b3.gif"> Apagar Campos</button>
</center></div></td></tr>
