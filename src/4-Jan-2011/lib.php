...
function display($content, $title, $topnav=true, $leftnav=true, $rightnav=true, $badstart=false) { // Finalize page and output to browser.
	...
	//TOPNAV AQUI
	global $topnav;
	if ($topnav == false) {$topnav = "";$rightnav = gettemplate("rightnav");$leftnav = gettemplate("leftnav");}
    ...
    if (isset($userrow)) {
        ...
        if ($userrow["currentaction"] == "In Town") {
            ...
            $userrow["currenttown"] = "Bem-vindo a(o) ".$townrow["name"].".";
        } else {
            $userrow["currenttown"] = "Você está explorando.";
        }
        ...
        $userrow["townslist"] = "<table background=\"images/naruto.jpg\" style=\"background-repeat:no-repeat;\"><tr><td><div style=\"padding-right: 12px;padding-left: 16px;padding-bottom: 73px; padding-top: 19px;\"><center>".$userrow["currenttown"]."</center></div></td></tr><tr><td><table border=\"1\" cellspacing=\"0\" cellpadding=\"0\" background=\"images/fundoviajar.png\" style=\"border:1px #000000 solid\"><tr style=\"border:1px #000000 solid\">";
		$quantas = 0;
		...
		$userrow["townslist"] .= "</tr></table></td></tr></table>";
