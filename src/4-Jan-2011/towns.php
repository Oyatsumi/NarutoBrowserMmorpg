...
function buy2($id) { // Confirm user's intent to purchase item.
    ...
    if ($itemsrow["type"] == 1) {
        if ($userrow["weaponid"] != 0) { 
            ...
            $page = personagemgeral("Você está comprando o(a) ".$itemsrow["name"].", então eu vou comprar o seu ".$itemsrow2["name"]." por ".ceil($itemsrow2["buycost"]/4)." Ryou. Tudo bem?<br /><br /><center><form action=\"index.php?do=buy3:$id\" method=\"post\"><div class=\"buttons\"><button type=\"submit\" class=\"positive\" name=\"submit\"><img src=\"layoutnovo/dropmenu/b1.gif\"> Sim</button>
...
<button type=\"reset\" class=\"negative\" name=\"reset\" onclick=\"javascript: location.href = 'index.php?do=buy'\"><img src=\"layoutnovo/dropmenu/b3.gif\"> Não</button>
        ...
        if ($userrow["armorid"] != 0) { 
            ...
            $itemsrow2 = mysql_fetch_array($itemsquery2);
            $page = personagemgeral("Você está comprando o(a) ".$itemsrow["name"].", então eu vou comprar: ".$itemsrow2["name"]." por ".ceil($itemsrow2["buycost"]/4)." Ryou. Está tudo bem?<br /><br /><center><form action=\"index.php?do=buy3:$id\" method=\"post\"><div class=\"buttons\"><button type=\"submit\" class=\"positive\" name=\"submit\"><img src=\"layoutnovo/dropmenu/b1.gif\"> Sim</button>
<button type=\"reset\" class=\"negative\" name=\"reset\" onclick=\"javascript: location.href = 'index.php?do=buy'\"><img src=\"layoutnovo/dropmenu/b3.gif\"> Não</button>
</div></form>", "personagem1", "Anari");
        } else {
            $page = personagemgeral("Você está comprando o(a) ".$itemsrow["name"].", está tudo certo?<br /><br /><center><form action=\"index.php?do=buy3:$id\" method=\"post\"><div class=\"buttons\"><button type=\"submit\" class=\"positive\" name=\"submit\"><img src=\"layoutnovo/dropmenu/b1.gif\"> Sim</button>
<button type=\"reset\" class=\"negative\" name=\"reset\" onclick=\"javascript: location.href = 'index.php?do=buy'\"><img src=\"layoutnovo/dropmenu/b3.gif\"> Não</button>
        ...
        if ($userrow["shieldid"] != 0) { 
            ...
            $itemsrow2 = mysql_fetch_array($itemsquery2);
            $page = personagemgeral("Você está comprando o(a) ".$itemsrow["name"].", então eu vou comprar: ".$itemsrow2["name"]." por ".ceil($itemsrow2["buycost"]/4)." Ryou. Está bem?<br /><br /><center><form action=\"index.php?do=buy3:$id\" method=\"post\"><div class=\"buttons\"><button type=\"submit\" class=\"positive\" name=\"submit\"><img src=\"layoutnovo/dropmenu/b1.gif\"> Sim</button>
<button type=\"reset\" class=\"negative\" name=\"reset\" onclick=\"javascript: location.href = 'index.php?do=buy'\"><img src=\"layoutnovo/dropmenu/b3.gif\"> Não</button>
</div></form>", "personagem1", "Anari");
        } else {
...
function maps() { // List maps the user can buy.
    ...
    $page .= "Clique no nome de uma vila/cidade para comprar seu mapa.<br /><br />\n";
    $page .= "<table width=\"90%\">\n";
...
function travelto($id, $usepoints=true) { // Send a user to a town from the Travel To menu.
    ...
    if ($usepoints==true) { 
        if ($userrow["currenttp"] < $townrow["travelpoints"]) { 
			...
			header('Location: /narutorpg/index.php?conteudo=Você não tem TP suficiente para viajar até lá. Por favor tente novamente quando você tiver mais TP.'); die();
