...
function fight() { // One big long function that determines the outcome of the fight.
   ...
   $pagearray["indexconteudo"] = $indexconteudo;
	...
	//Graficos
        ...
        if ($pickedspell == 0) { header("Location: /narutorpg/index.php?do=fight&avisochakra=Você deve selecionar um Jutsu primeiro.");die();}
        ...
        if ($userrow["currentmp"] < $newspellrow["mp"]) { header("Location: /narutorpg/index.php?do=fight&avisochakra=Você não tem chakra suficiente para usar o(a) ".$newspellrow["name"].".");die(); } //chakra jutsu.
...
<table width=\"165\" height=\"175\" background=\"layoutnovo/graficos/fundo.png\" style=\"background-repeat:no-repeat;;background-position:left top\"><tr height=\"30%\"><td></td></tr><tr><td><center><img src=\"layoutnovo/graficos/".$userrow["avatar"]."_ganhou.gif\"></center>
            ...
            if (rand(1,$droprat) <= $sorte) {
                ...
                $page = "<center>Esse inimigo dropou um item. Clique na exclamação acima para equipar o item, ou você pode continuar <a href=\"index.php\">explorando</a> e ignorar o item.</center>";
...
<tr><td align=\"center\"><center><img src=\"images/title_fighting.gif\" alt=\"Fighting\" /></center></td></tr></table>
			...
			<br><br>Parabéns. Você derrotou ".$monsterrow["name"].".<br />Você ganhou $exp de experiência. $warnexp <br />Você ganhou $gold Ryou. $warngold $msgfim<br /><br />$mostrarexc</center>
...
function drop() {
    ...
    if (isset($_POST["submit"])) {
      ...
      header("Location: /narutorpg/index.php?conteudo=O item foi equipado ou adicionado à mochila com sucesso.");die();
    ...
    $page = "<table width=\"100%\"><tr><td width=\"100%\" align=\"center\"><center><img src=\"images/drop.gif\" /></center></td></tr></table><center><table><tr><td width=\"50%\"><center>O inimigo dropou o seguinte item: <br><br><table><tr bgcolor=\"#613003\"><td><center><font color=white><b>".$droprow["name"]."</b></font></center></td></tr>";
