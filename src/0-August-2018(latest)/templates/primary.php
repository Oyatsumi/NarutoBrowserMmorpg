...
//Vari?vel da div da janela transparente de mensagens.
global $mainmsg;
...
document.getElementById(nome).innerHTML="<table width=\"100%\"><tr bgcolor=\"#E4D094\"><td width=\"130\">Requerimento: " + monstroprocurado + local + "</td><td>" + requerimento + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Recompensa:</td><td>" + recompensa + "</td></tr><tr bgcolor=\"#E4D094\"><td>Local de Conclus?o:</td><td>" + localtreino + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>N?vel:</td><td>" + nivel + "</td></tr><tr bgcolor=\"#E4D094\"><td>Conclus?o:</td><td>" + conclusao + "</td></tr></table>";}
else{document.getElementById(nome).innerHTML="<table width=\"100%\"><tr bgcolor=\"#E4D094\"><td width=\"130\">Requerimento: " + monstroprocurado + local + "<a href=\"javascript: openmaprespawn('" + itemprocurado + "')\"><img src=\"images/maximizar.gif\" border=\"0\" title=\"Mostrar Onde Dropa o(a) " + itemprocurado + "\"></a></td><td>" + requerimento + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Recompensa:</td><td>" + recompensa + "</td></tr><tr bgcolor=\"#E4D094\"><td>Local de Conclus?o:</td><td>" + localtreino + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>N?vel:</td><td>" + nivel + "</td></tr><tr bgcolor=\"#E4D094\"><td>Conclus?o:</td><td>" + conclusao + "</td></tr></table>";}
}
...
function yesorno(objeto, conteudo, yes, no){
	...
	document.getElementById("explicmenu").style.left = localx + "px";
	document.getElementById("explicmenu").style.top = localy + "px";
	document.getElementById('explicmenu').innerHTML = "<table width=\"174\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" background=\"layoutnovo/dropmenu/transparente/fundotabela.png\" style=\"background-repeat:no-repeat;;background-position:center center\" ><tr><td background=\"layoutnovo/dropmenu/transparente/cima.png\" style=\"background-repeat:no-repeat;\" height=\"20\"><center><div style=\"padding-top: 3px\">" + conteudo + "</div></center></td></tr><tr><td><center><table><tr><td></td><td><center><a href=\"" + yes + "\" title=\"Sim\"><img src=\"images/aceitar.gif\" border=\"0\"></a><a href=\"" + no + "\" title=\"N?o\"><img src=\"images/deletar.gif\" border=\"0\"></a></center></td></tr></table></center></td></tr><tr><td background=\"layoutnovo/dropmenu/transparente/fim.png\" height=\"7\"></td></tr></table>";
}
