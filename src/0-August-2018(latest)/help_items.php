...
<center>[ <a href=\"help.php\">Voltar � Ajuda</a> | <a href=\"index.php\">Voltar ao jogo</a> ]</center>
...
while ($itemsrow = mysqli_fetch_array($itemsquery)) {
    ...
    if ($itemsrow["type"] == 1) { $image = "weapon"; $power = "Ataque"; } elseif ($itemsrow["type"] == 2) { $image = "armor"; $power = "Destreza"; } else { $image = "shield"; $power = "Destreza"; }
    if ($itemsrow["special"] != "X") {
        ...
        elseif ($special[0] == "goldbonus") { $attr = "B�nus Ryou (%)"; }
        elseif ($special[0] == "expbonus") { $attr = "B�nus Experi�ncia (%)"; }
        elseif ($special[0] == "strength") { $attr = "For�a"; }
		...
		elseif ($special[0] == "determinacao") { $attr = "Determina��o"; }
		elseif ($special[0] == "precisao") { $attr = "Precis�o"; }
		elseif ($special[0] == "inteligencia") { $attr = "Intelig�ncia"; }
...
while ($itemsrow = mysqli_fetch_array($itemsquery)) {
    ...
    if ($itemsrow["attribute1"] != "X") {
        ...
        elseif ($special1[0] == "goldbonus") { $attr1 = "B�nus Ryou (%)"; }
        elseif ($special1[0] == "expbonus") { $attr1 = "B�nus Experi�ncia (%)"; }
        elseif ($special1[0] == "strength") { $attr1 = "For�a"; }
		...
		elseif ($special1[0] == "determinacao") { $attr1 = "Determina��o"; }
		elseif ($special1[0] == "precisao") { $attr1 = "Precis�o"; }
		elseif ($special1[0] == "inteligencia") { $attr1 = "Intelig�ncia"; }
    ...
    if ($itemsrow["attribute2"] != "X") {
        ...
        elseif ($special2[0] == "goldbonus") { $attr2 = "B�nus Ryou (%)"; }
        elseif ($special2[0] == "expbonus") { $attr2 = "B�nus Experi�ncia (%)"; }
        elseif ($special2[0] == "strength") { $attr2 = "For�a"; }
		...
		elseif ($special2[0] == "determinacao") { $attr2 = "Determina��o"; }
		elseif ($special2[0] == "precisao") { $attr2 = "Precis�o"; }
		elseif ($special2[0] == "inteligencia") { $attr2 = "Intelig�ncia"; }
