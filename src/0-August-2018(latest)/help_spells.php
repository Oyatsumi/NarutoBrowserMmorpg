...
while ($itemsrow = mysqli_fetch_array($itemsquery)) {
    ...
    elseif ($itemsrow["type"] == 5) { $type = "+Destreza (%)"; }
...
<ul>
<li /><b>Medicinal</b> esse tipo sempre te d� o maximo de cura poss�vel.
<li /><b>Dano</b> esse tipo causa nem sempre o m�ximo dano ao monstro, dependendo da defesa do monstro.
<li /><b>Sono</b> esse tipo coloca o monstro pra dormir. O mesmo tem alguma chance em 15 de permanecer dormindo em cada turno, dependendo do n�vel do Jutsu.
<li /><b>+Dano</b> esse tipo aumenta o seu total de ataque pela porcentagem at� o fim da luta.
<li /><b>+Destreza</b> esse tipo reduz o dano do ataque que voc� recebe pela porcentagem at� o fim da luta.
</ul>
</center>";
