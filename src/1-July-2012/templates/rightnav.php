...
<center><div onmouseover="explicdrop('qualquer', 'Barras de Status', '<center><div style=\'margin-top:0px;color:white;background-color:#780404;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px;display:block\'>HP: {{currenthp}}/{{maxhp}}</div><div style=\'margin-top:0px;color:white;background-color:#024179;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px;display:block\'>CH: {{currentmp}}/{{maxmp}}</div><div style=\'margin-top:0px;color:white;background-color:#766402;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px;display:block\'>TP: {{currenttp}}/{{maxtp}}</div><div style=\'margin-top:0px;color:white;background-color:#0d6504;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px;display:block\'>NP: {{currentnp}}/{{maxnp}}</div><div style=\'margin-top:0px;color:white;background-color:#6f0576;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px;display:block\'>EP: {{currentep}}/{{maxep}}</div></center>','1','1')" onmouseout='fecharexplic();'>{{statbars}}</div></center>
<ul>
