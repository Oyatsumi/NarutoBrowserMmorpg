...
function mostrarquest(numero, recompensa, requerimento, localtreino, nivel, conclusao, itemprocurado){
nome = "elemento" + numero;
if (itemprocurado == undefined){
document.getElementById(nome).innerHTML="<table width=\"100%\"><tr bgcolor=\"#E4D094\"><td width=\"130\">Requerimento:</td><td>" + requerimento + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Recompensa:</td><td>" + recompensa + "</td></tr><tr bgcolor=\"#E4D094\"><td>Local de Conclusão:</td><td>" + localtreino + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Nível:</td><td>" + nivel + "</td></tr><tr bgcolor=\"#E4D094\"><td>Conclusão:</td><td>" + conclusao + "</td></tr></table>";}
else{document.getElementById(nome).innerHTML="<table width=\"100%\"><tr bgcolor=\"#E4D094\"><td width=\"130\">Requerimento: <a href=\"javascript: openmaprespawn('" + itemprocurado + "')\"><img src=\"images/maximizar.gif\" border=\"0\" title=\"Mostrar Onde Dropa o Item\"></a></td><td>" + requerimento + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Recompensa:</td><td>" + recompensa + "</td></tr><tr bgcolor=\"#E4D094\"><td>Local de Conclusão:</td><td>" + localtreino + "</td></tr><tr bgcolor=\"#FFF1C7\"><td>Nível:</td><td>" + nivel + "</td></tr><tr bgcolor=\"#E4D094\"><td>Conclusão:</td><td>" + conclusao + "</td></tr></table>";}
}
...
if (IE){
	document.write('<style type="text/css">	fieldset{background-image: url("layoutnovo/dropmenu/fundo.jpg");padding:3px;padding-bottom:6px;background-repeat: repeat;margin-top:	3px;margin-left:30px;margin-right:30px;border: solid 1px black;	background-position: bottom right;}</style>');}else{document.write('<style type="text/css">	fieldset {padding:3px;padding-bottom:6px;background-image: url("layoutnovo/dropmenu/narutoformback.jpg"), url("layoutnovo/dropmenu/fundo.jpg");background-repeat: no-repeat, repeat;background-position: bottom right, top left;	margin-top:	3px;margin-left:30px;margin-right:30px;border: solid 1px black;}</style>');
}
...
<div id="dropmenu" style="z-index:5;position:absolute;left:300px;top:300px" align="left"></div>
