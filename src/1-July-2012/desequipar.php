...
if (($userrow["currentaction"] == "Fighting") && ($deletar == false)) {header('Location: ./index.php?do=fight&conteudo=Você não pode desequipar um item no meio de uma batalha!');die();}
...
for ($i = 4;$i > 0; $i--){
	...
	if (($i == 1) && ($bpcertonum == 0) && ($deletar == false)){
		header('Location: ./index.php?conteudo=Sua mochila já está cheia.'); die();
	}
}
