...
function menudrop(objeto, titulo, conteudo, x, y){
	...
	var localx = parseInt(tempX) + parseInt(x) - 165;
	...
	document.getElementById('dropmenu').innerHTML = "<table width=\"174\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" background=\"layoutnovo/dropmenu/fundotabela.gif\" style=\"background-repeat:no-repeat;;background-position:center center\" ><tr><td background=\"layoutnovo/dropmenu/cima.gif\" style=\"background-repeat:no-repeat;;background-position:center center\" height=\"5\"><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td height=\"5\" colspan=\"2\"></td></tr><tr><td width=\"178\" height=\"5\"><center><b>" + titulo + "</b></center></td><td align=\"left\" width=\"*\"><a href=\"javascript:fechardrop();\"><img src=\"layoutnovo/dropmenu/fechar.gif\" border=\"0\"></a></td></tr></table></td></tr><tr><td background=\"layoutnovo/dropmenu/meio.gif\"><table><tr><td></td><td>" + conteudo + "</td></tr></table></td></tr><tr><td background=\"layoutnovo/dropmenu/fim.gif\" height=\"7\"></td></tr></table>";
}
...
function menudropdir(objeto, titulo, conteudo, x, y){
	...
	document.getElementById("dropmenu").style.left = localx + "px";
	document.getElementById("dropmenu").style.top = localy + "px";
	document.getElementById('dropmenu').innerHTML = "<table width=\"174\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" background=\"layoutnovo/dropmenu/direita/fundotabela.gif\" style=\"background-position:center center\" ><tr><td background=\"layoutnovo/dropmenu/direita/cima.gif\" style=\"background-repeat:no-repeat;;background-position:top left\" height=\"5\"><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td height=\"5\" colspan=\"2\"></td></tr><tr><td width=\"178\" height=\"5\"><center><b><div style=\"position:relative; top: -2px\">" + titulo + "</div></b></center></td><td align=\"left\" width=\"*\"><div style=\"position:relative; top: -1px\"><a href=\"javascript:fechardrop();\"><img src=\"layoutnovo/dropmenu/direita/fechar.gif\" border=\"0\"></a></div></td></tr></table></td></tr><tr><td background=\"layoutnovo/dropmenu/direita/meio.gif\"><table><tr><td></td><td>" + conteudo + "</td></tr></table></td></tr><tr><td background=\"layoutnovo/dropmenu/direita/fim.gif\" height=\"7\"></td></tr></table>";
}
function explicdrop(objeto, titulo, conteudo, x, y){
	document.getElementById(objeto).onclick = getMouseXY;

	var localx = parseInt(tempX) + parseInt(x) - 90;
