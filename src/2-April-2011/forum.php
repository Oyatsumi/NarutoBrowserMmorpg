...
function donothing($start=0) {
    ...
    if (mysql_num_rows($query) == 0) { 
        $page .= "<tr><td style=\"background-color:#FFF1C7;\" colspan=\"3\"><b>No threads in forum.</b></td></tr>\n";
    } else { 
    ...
    $page .= "</table></td></tr></table><center><a href=\"forum.php?do=new\"><img src=\"images/novotopico.gif\" title=\"Criar Novo T&oacute;pico\" border=\"0\"></a></center>";
