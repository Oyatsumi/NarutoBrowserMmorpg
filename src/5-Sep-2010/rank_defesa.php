...
<td width="500">
<a name="top"></a>
<h1><? echo $controlrow["gamename"]; ?> : Rank por Poder de Defesa</h1>
...
<tr><td colspan="5" bgcolor="#ffffff"><center><b>Rank por Poder de Defesa</b></center></td></tr>
<tr><td><b>Rank</b></td><td><b>Poder de Defesa</b></td><td><b>Level</b></td><td><b>Nome</b></td></tr>
<?
$count = 1;
$usersquery = doquery("SELECT * FROM {{table}} ORDER BY defensepower DESC limit 42", "users");
while ($usersrow = mysql_fetch_array($usersquery)) {
    ...
    echo "<tr><td $color width=\"1%\">$contagemrank</td><td $color width=\"5%\">".$usersrow["defensepower"]."</td><td $color width=\"5%\">".$usersrow["level"]."</td><td $color width=\"30%\">".$usersrow["charname"]."</td></tr>\n";
	}
}
?>
</table><br />
