...
while ($itemsrow = mysql_fetch_array($itemsquery)) {
    ...
    echo "<tr><td $color width=\"5%\"><img src=\"images/icon_$image.gif\" alt=\"$image\"></td><td $color width=\"30%\">".$itemsrow["name"]."</td><td $color width=\"20%\">".$itemsrow["buycost"]." Ryou</td><td $color width=\"20%\">".$itemsrow["attribute"]." Poder de $power </td><td $color width=\"25%\">$bigspecial</td></tr>\n";
}
?>
</table>
<br />
