...
<tr><td height="210" width="224" colspan="3" background="layoutnovo/menuslados/kakashi.png"></td></tr>
...
<a href="outros.php?do=avatar">Selecionar Avatar</a>.</center><br>$olhosenjutsu
<b>{{charname}}</b><br />
Level: {{level}}<br />
Exp: {{experience}}<br />
Ryou: {{gold}}<br />
