...
function display($content, $title, $topnav=true, $leftnav=true, $rightnav=true, $badstart=false) { // Finalize page and output to browser.
	...
	//TOPNAV AQUI
	global $topvar;
	if ($topvar == true) {$topnav = "<a href=\"index.php\"><img src=\"images/voltar.gif\" alt=\"Voltar ao Jogo\" border=\"0\" title=\"Voltar ao Jogo\" /></a><a href=\"login.php?do=logout\"><img src=\"images/sair.gif\" alt=\"Sair\" title=\"Sair\" border=\"0\" /></a><a href=\"help.php\" target=\"_blank\" ><img src=\"images/ajuda.gif\" alt=\"Ajuda\" title=\"Ajuda\" border=\"0\" /></a>";$rightnav = gettemplate("rightnav");$leftnav = gettemplate("leftnav");}
