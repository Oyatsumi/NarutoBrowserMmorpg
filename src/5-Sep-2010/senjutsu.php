...
$conteudodois = " 
 ...
 Olá pequeno ninja, você veio até mim à procura da Arte Eremita? O Senjutsu é um tipo de jutsu que precisa de 12 treinamentos em intervalos de 900 minutos(15 horas) para ser aperfeiçoado... Quando ativado, ele concederá 10% a mais de ataque e defesa para que você possa enfrentar o inimigo. Se mesmo assim você ainda não desistiu, podemos <a href=\"senjutsu.php?do=aprendendo2\">começar agora mesmo</a> o treinamento.
</td></tr></table>
";
    ...
    /* testando se está logado */
		...
		if ($userrow["senjutsuhtml"] != ""){//o jogador possui o senjutsu.
			...
			if ($userrow["senjutsuhtml"] == "fechado"){//possui e o olho está fechado.
					$today = date("j/n/Y");
					$todayhour = date("H:i:s");
					$userrow["atkdefsenjutsu"] = floor(($userrow["attackpower"]*10)/100).",".floor(($userrow["defensepower"]*10)/100);
					$userrow["attackpower"] += floor(($userrow["attackpower"]*10)/100);
					$userrow["defensepower"] += floor(($userrow["defensepower"]*10)/100);
