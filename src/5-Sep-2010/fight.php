	...
	//Graficos
        ...
        if ($newspellrow["type"] == 1) { // Heal spell.
            ...
            if ($userrow["currentmonsterimmune"] == 0) {
                ...
                $userrow["currentmonsterhp"] -= $monsterdamage;
                $pagearray["yourturn"] = "Você usou: ".$newspellrow["name"]." e causou $monsterdamage de dano.<br /><br />";
            } else {
                $pagearray["yourturn"] = "Você usou: ".$newspellrow["name"].", mas o inimigo é imune à seu Jutsu.<br /><br />";
            }
            $userrow["currentmp"] -= $newspellrow["mp"];
...
<table width=\"165\" height=\"175\" background=\"layoutnovo/graficos/fundo.png\" style=\"background-repeat:no-repeat;;background-position:left top\"><tr height=\"30%\"><td></td></tr><tr><td><center><img src=\"layoutnovo/graficos/".$userrow["avatar"]."_ganhou.gif\"></center>
			...
			";
            $title = "A determinação foi sua sorte!";
            $dropcode = "";
...
<tr><td align=\"center\"><center><img src=\"images/title_fighting.gif\" alt=\"Fighting\" /></center></td></tr></table>
			...
			<br><br>Parabéns. Você derrotou ".$monsterrow["name"].".<br />Você ganhou $exp de experiência. $warnexp <br />Você ganhou $gold Ryou. $warngold <br /><br />$mostrarexc</center>
...
function drop() {
    ...
    $page .= "<br />Selecione um slot do inventário da lista abaixo para equipar o item. Se o slot estiver cheio, o Item antigo será descartado.<br><br>";
 ...
 <input type=\"submit\" name=\"submit\" value=\"OK!\" /></form></center><br>";
    $page .= "<center>Você pode também continuar <a href=\"index.php\">explorando</a> e descartar esse item.</center>";
