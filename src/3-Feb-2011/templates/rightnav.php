...
$bpcodigo[$i] = "<a href=\"backpack.php?qual=$i\"><img src=\"layoutnovo/equipamentos/$pastadoslot".$varbackpack[$i][1].".png\" width=\"34\" height=\"34\" hspace=\"0\" vspace=\"0\" border=\"0\" onmouseover=\"".$varbackpack[$i][0]."\" onmouseout=\"fecharexplic();\"  id=\"bp".$i."atr\"/></a>";}else{
...
$porcconcluida = round((($userrow['experience']  - $lvlrow[$userrow['charclass']."_exp"]) * 100) / $xpproxlvl);
$quantofaltaxp = $xpproxlvl - ($userrow['experience']  - $lvlrow[$userrow['charclass']."_exp"]);
$widthbar = round((160 * $porcconcluida)/100);
