...
<td height="37" width="23"></td><td width="31"></td><td width="31" style="background-repeat:no-repeat;;background-position:left top" background="layoutnovo/equipamentos/{{shieldid}}.png"><img src="images/gif30.gif" onMouseOver="{{shieldatr}}" onmouseout="fecharexplic();" id="shieldatr" border="0"></td><td colspan="2"></td></tr><tr>

<td  height="34" width="23"></td><td width="31" style="background-repeat:no-repeat;;background-position:left top" background="layoutnovo/equipamentos/{{weaponid}}.png"><img src="images/gif30.gif" border="0" onMouseOver="{{armaatr}}" onmouseout="fecharexplic();" id="armaatr"></td><td width="31" style="background-repeat:no-repeat;;background-position:left top" background="layoutnovo/equipamentos/{{armorid}}.png"><img src="images/gif30.gif" border="0" onMouseOver="{{armoratr}}" onmouseout="fecharexplic();" id="armoratr"></td><td style="background-repeat:no-repeat;;background-position:left top" background="layoutnovo/equipamentos/{{weaponid}}d.png"><img src="images/gif30.gif" border="0" onMouseOver="{{armaatr}}" onmouseout="fecharexplic();" id="armaatr"></td></tr>
<tr>
