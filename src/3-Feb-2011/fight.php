...
function fight() { // One big long function that determines the outcome of the fight.
   ...
   $pagearray["indexconteudo"] = $indexconteudo;
	...
	$pagearray["dados"] = "<center><table width=\"95%\" bgcolor=\"#452202\"><tr><td colspan=\"4\" bgcolor=\"#452202\"><font color=\"white\"><center>Dados do Inimigo</center></font></td></tr><tr bgcolor=\"#e4d094\"><td ><b><center>Nome</center></b></td><td ><b><center>Level</center></b></td><td ><b><center>Imunidade</center></b></td><td ><b><center>Elemento</center></b></td>
	
	</tr><tr bgcolor=\"#fff1c7\"><td ><center>".$monsterrow["name"]."</center></td><td ><center>".$monsterrow["level"]."</center></td><td ><center>$immune</center></td><td ><center><img src=\"images/".$monsterrow["elemento"].".gif\" title=\"Elemento ".ucfirst($monsterrow["elemento"])."\"></center></td>
	
	
	</tr><tr bgcolor=\"#e4d094\"><td ><b><center><font color=\"darkred\">HP</font></center></b></td><td ><center><b>MaxDam</b></center></td><td ><b><center>Armadura</b></center></td><td ><b><center>MaxExp</center></br></td></tr>
	
	<tr bgcolor=\"#fff1c7\"><td ><center>".$userrow["currentmonsterhp"]."</center></td><td ><center>".$monsterrow["maxdam"]."</center></td><td ><center>".$monsterrow["armor"]."</center></td><td ><center>".$monsterrow["maxexp"]."</center></td></tr>
	...
	//Graficos
        ...
        if ($newspellrow["type"] == 1) { // Heal spell.
            ...
            if ($userrow["currentmonsterimmune"] == 0) {
				...
				if ($monsterdamagemult == 3/2){$cont = " Seu ataque foi super efetivo.";}
				elseif ($monsterdamagemult == 1/2){$cont = " Seu ataque foi pouco efetivo.";}else{$cont = "";}
				//Fim de colocando o dano de elemento.
        ...
        if ($userrow["currentmonstersleep"] == 0) { // Only do this if the monster is awake.
            ...
            if ($tododge <= sqrt($userrow["dexterity"])) {
				...
				$monsterdamagemult = elementoganhador($monsterrow2['elemento'], $explodirelemento[0]);
...
function victory() {
	...
	//Dados do monstro
	if ($monsterrow["immune"] == 0) { $immune = "<span class=\"light\">None</span>"; } elseif ($monsterrow["immune"] == 1) { $immune = "Dano"; } else { $immune = "Dano & Sono"; }
	$pagearray["dados"] = "<div style=\"position: relative; top: -25px; margin-bottom: -30px;\"><br><br></center><center><table width=\"95%\" bgcolor=\"#452202\"><tr><td colspan=\"4\"><font color=\"white\"><center>Dados do Inimigo</center></font></td></tr><tr bgcolor=\"#e4d094\"><td ><b><center>Nome</center></b></td><td ><b><center>Level</center></b></td><td ><b><center>Imunidade</center></b></td><td ><b><center>Elemento</center></b></td>
	...
	<tr bgcolor=\"#fff1c7\"><td ><center><blink><font color=\"red\">".$userrow["currentmonsterhp"]."</red></blink></center></td><td ><center>".$monsterrow["maxdam"]."</center></td><td ><center>".$monsterrow["armor"]."</center></td><td ><center>".$monsterrow["maxexp"]."</center></td></tr>
...
<tr><td align=\"center\"><center><img src=\"images/title_fighting.gif\" alt=\"Fighting\" /></center></td></tr></table>
			...
			<table><tr><td width=\"310\" valign=\"middle\">".$pagearray["dados"]."<center>
			<br>Parabéns. Você derrotou o inimigo <b>".$monsterrow["name"]."</b>.<br><br><b>Você passou de nível!</b><br /><br>Você ganhou:<br><table><tr><td><img src=\"images/seta.gif\">+ $exp de experiência. $warnexp <br /><img src=\"images/seta.gif\">+ $gold de Ryou. $warngold <br /><img src=\"images/seta.gif\">+".$levelrow[$userrow["charclass"]."_hp"]." Pontos de Vida.<br /><img src=\"images/seta.gif\">+".$levelrow[$userrow["charclass"]."_mp"]." Pontos de Chakra.<br /><img src=\"images/seta.gif\">+".$levelrow[$userrow["charclass"]."_tp"]." Pontos de Viagem.<br /><img src=\"images/seta.gif\">+$novospontosamostrar Pontos de Distribuição.<br /><img src=\"images/seta.gif\">+5 Pontos Naturais.<br /><img src=\"images/seta.gif\">+".$levelrow[$userrow["charclass"]."_strength"]." de ataque.<br /><img src=\"images/seta.gif\">+".$levelrow[$userrow["charclass"]."_dexterity"]." de defesa.$msgfim$spelltext</td></tr></table></center>
...
<table width=\"165\" height=\"175\" background=\"layoutnovo/graficos/fundo.png\" style=\"background-repeat:no-repeat;;background-position:left top\"><tr height=\"30%\"><td></td></tr><tr><td><center><img src=\"layoutnovo/graficos/".$userrow["avatar"]."_ganhou.gif\"></center>
...
</td></tr></table></div><br /><center>Você pode continuar <a href=\"index.php\">explorando</a>.</center></div>
			";
			...
			$droprat = 22 - (20*$userrow["droprate"]/100);
...
<tr><td align=\"center\"><center><img src=\"images/title_fighting.gif\" alt=\"Fighting\" /></center></td></tr></table>
			...
			<br>Parabéns. Você derrotou <b>".$monsterrow["name"]."</b>.<br /><br>Você ganhou:<br><table><tr><td><img src=\"images/seta.gif\">+$exp de experiência. $warnexp <br /><img src=\"images/seta.gif\">+ $gold Ryou. $warngold $msgfim<br /></td></tr></table></center>
...
function drop() {
	...
	$page .= "</table></td><td><div style=\"padding-top: 3px\"><img src=\"layoutnovo/equipamentos/drops/".$droprow["id"].".png\" style=\"border:2px #e4d094 solid;\" id=\"idatr\" onmouseout=\"fecharexplic();\" onmouseover=\"$agorajava\"></div></td></tr></table></center><br>";
 ...
 <input type=\"submit\" name=\"submit\" value=\"OK!\" /></form></center></td></tr></table><br>";
    $page .= "<br><center>Você também pode continuar <a href=\"index.php\">explorando</a> e descartar esse item.</center>";
