...
$chat
<center><form action="chat.php?do=chatmap" method="post"> <input type="text" name="fala" size="66" maxlength="200"><input type="submit" id="submit2" name="submit" value="OK" style="margin-left:2px;width:28px"></form></center>
</div></td></tr>
</table>
END;
...
function babblebox() {
	...
	if ($tamanho != 15){$colocar = "&tamanho=55";}
    $babblebox["content"] .= "<center><form action=\"index.php?do=babblebox&$colocar\" method=\"post\"><input type=\"text\" name=\"babble\" size=\"$tamanho\" maxlength=\"120\" /><br /><div class=\"buttons\" style=\"padding-left: 9px;\"><center><button type=\"submit\" class=\"positive\" name=\"submit\"><img src=\"layoutnovo/dropmenu/b1.gif\"> Falar</button></form>
</center></div>";
