...
function victory() {
    ...
    if ($userrow["level"] < 100) {
        if ($newexp >= $levelrow[$userrow["charclass"]."_exp"]) {
            ...
            $newspell = "";
            $page = "Parabéns. Você derrotou ".$monsterrow["name"].".<br />Você ganhou $exp de experiência. $warnexp <br />Você ganhou $gold Ryou. $warngold <br /><br />";
            ...
            if (rand(1,30) == 1) {
                ...
                $page .= "Esse inimigo dropou um item. <a href=\"index.php?do=drop\">Clique aqui</a> para viajar e equipar o item, ou você pode se mover e continuar <a href=\"index.php\">explorando</a>.";
            } else { 
                $dropcode = "";
                $page .= "Você pode continuar <a href=\"index.php\">explorando</a>.";
            }
