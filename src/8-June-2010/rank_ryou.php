...
<tr><td><b>Ryou</b></td><td><b>Level</b></td><td><b>Nome</b></td></tr>
<?
$count = 1;
$usersquery = doquery("SELECT * FROM {{table}} ORDER BY gold DESC", "users");
while ($usersrow = mysql_fetch_array($usersquery)) {
    ...
    echo "<tr><td $color width=\"5%\">".$usersrow["gold"]."</td><td $color width=\"5%\">".$usersrow["level"]."</td><td $color width=\"30%\">".$usersrow["charname"]."</td></tr>\n";
	}
}
?>
</table>
