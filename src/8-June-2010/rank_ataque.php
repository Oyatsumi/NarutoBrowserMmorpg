...
<body>
<a name="top"></a>
<h1><? echo $controlrow["gamename"]; ?> : Rank por Ataque</h1>
...
<tr><td colspan="5" bgcolor="#ffffff"><center><b>Rank por Ataque</b></center></td></tr>
<tr><td><b>Ataque</b></td><td><b>Level</b></td><td><b>Nome</b></td></tr>
<?
$count = 1;
$usersquery = doquery("SELECT * FROM {{table}} ORDER BY strength DESC", "users");
while ($usersrow = mysql_fetch_array($usersquery)) {
    ...
    echo "<tr><td $color width=\"5%\">".$usersrow["strength"]."</td><td $color width=\"5%\">".$usersrow["level"]."</td><td $color width=\"30%\">".$usersrow["charname"]."</td></tr>\n";
	}
}
?>
</table>
