...
$updatequery = doquery("UPDATE {{table}} SET currentmp='".$userrow["currentmp"]."', currentnp='".$userrow["currentnp"]."',currenthp='".$userrow["currenthp"]."', recuperarvida='0' WHERE charname='$usuariologadonome' LIMIT 1","users");
	...
	$indexconteudo = "<div style=\"z-index: 2;position:relative;\"><center><table  bgcolor=\"#452202\"><tr><td width=\"18\"></td><td width=\"*\"><center><font color=white>Descansando</font></center></td><td width=\"18\"><a href=\"index.php\"><img src=\"images/deletar2.jpg\" title=\"Parar de Descansar\"  alt=\"X\" border=\"0\"></a></td></tr><tr><td background=\"layoutnovo/menumeio/meio2.png\" colspan=\"3\"><font color=\"black\"><center>".$indexconteudo."</center></font></td></tr></table></center></div>";
	include('index.php');
	die();
