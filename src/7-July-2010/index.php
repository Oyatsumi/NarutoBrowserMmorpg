...
function dotown() { // Spit out the main town page.
	...
	$updatequery = doquery("UPDATE {{table}} SET imagem='nacidade.png' WHERE charname='".$userrow["charname"]."' LIMIT 1","users");
...
function doexplore() { // Just spit out a blank exploring page.
	...
	//imagem da cidade, etc
	$updatequery = doquery("UPDATE {{table}} SET imagem='explorando.png' WHERE charname='".$userrow["charname"]."' LIMIT 1","users");
...
$page = <<<END
<table width="100%">
<tr><td align="center"><center><img src="images/title_exploring.gif" alt="Explorando" /></center></td></tr>
<tr><td>
