...
function display($content, $title, $topnav=true, $leftnav=true, $rightnav=true, $badstart=false) { // Finalize page and output to browser.
	...
	if ($topnav == true) {
        $topnav = "<a href=\"index.php\"><img src=\"images/jogar.gif\" alt=\"Voltar a Jogar\" border=\"0\" /></a><br><a href=\"login.php?do=logout\"><img src=\"images/button_logout.gif\" alt=\"Log Out\" title=\"Log Out\" border=\"0\" /></a><br> <a href=\"help.php\"><img src=\"images/button_help.gif\" target=\"_blank\" alt=\"Help\" title=\"Help\" border=\"0\" /></a>";
    } else {
	...
	//TOPNAV AQUI
	global $topvar;
	if ($topvar == true) {$topnav = "<a href=\"index.php\"><img src=\"images/jogar.gif\" alt=\"Voltar a Jogar\" border=\"0\" /></a><br><a href=\"login.php?do=logout\"><img src=\"images/button_logout.gif\" alt=\"Log Out\" title=\"Log Out\" border=\"0\" /></a><br><a href=\"help.php\"><img src=\"images/button_help.gif\" target=\"_blank\" alt=\"Ajuda\" border=\"0\" /></a>";$rightnav = gettemplate("rightnav");$leftnav = gettemplate("leftnav");}
    ...
    if (isset($userrow)) {
        ...
        if ($userrow["currentaction"] == "In Town") {
            ...
            $userrow["currenttown"] = "Bem-vindo ao <b>".$townrow["name"]."</b>.<br /><br />";
        } else {
            $userrow["currenttown"] = "";
        }
        ...
        $stattable .= "</tr><tr><td>HP</td><td>CH</td><td>TP</td></tr></table>\n";
